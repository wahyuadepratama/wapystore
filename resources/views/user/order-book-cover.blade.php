              ...
              <div class="row">
                <div class="col-xs-12">
                    <div class="breadcrumbs-inner">
                        <h1 class="breadcrumbs-title">Book Cover</h1>
                    ...
                    <div class="tab-content" style="color: black;">
                        ...
                        <div class="tab-pane active" id="isi-form">
                            <div class="checkout-content box-shadow p-30">
                                <form action="/order/book-cover/store" method="post" enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                    <div class="row">
                                        <div class="col-md-6" style="margin-bottom: 10%">
                                            <div class="billing-details pr-10">
                                                <h6 class="widget-title border-left mb-20">Ketentuan Order Book Cover</h6>
                                                <li>
                                                  1. Mengisi <b>form pesanan</b> selengkap mungkin
                                                </li>
                                                <li>
                                                  2. Biaya desain book-cover <b>Rp {{number_format((Config::get('price.book-cover')),0,',','.')}} ,-</b>
                                                </li>
                                                <li>
                                                  3. Pengerjaan paling cepat adalah {{ Config::get('time-work.book-cover') }} hari
                                                </li>
                                            </div>
                                            <div class="billing-details pr-10" style="margin-top: 15%">
                                                ...
                                                <li>
                                                  2. Anda akan mendapatkan kesempatan revisi sebanyak {{ Config::get('revision.book-cover') }}x
                                                </li>
                                            </div>
                                        </div>
                                        <!-- billing details -->
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="billing-details pr-10">
                                                <h6 class="widget-title border-left mb-20">Order Book Cover</h6>
                                                ...
                                                @endif
                                                <textarea value="{{ old('content') }}" name="content" class="custom-textarea" placeholder="Jelaskan konten halaman depan dan belakang dari cover book disini " required></textarea>
                                                ...
                                                <small><i> (Opsional) Lampirkan file pendukung yang harus ada di dalam book-cover, seperti logo, dsb. Max: 5MB (format: zip, rar, png, atau jpg) </i></small>
                                            </div>
                                            <div class="col-md-12">
