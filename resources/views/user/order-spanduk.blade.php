                                  ...
                                  {{ csrf_field() }}
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="billing-details pr-10">
                                                <h6 class="widget-title border-left mb-20">Order Spanduk</h6>
                                                ...
                                                @endif
                                                <textarea value="{{ old('content') }}" name="content" class="custom-textarea" placeholder="Jelaskan konten spanduk disini. Terdiri dari nama acara, tanggal, waktu, lokasi, jargon, nama organisasi dan konten lainnya " required></textarea>
                                                ...
                                                <small><i> (Opsional) Lampirkan file pendukung yang harus ada di dalam spanduk, seperti logo, dsb. Max: 5MB (format: zip, rar, png, atau jpg) </i></small>
                                            </div>
                                            <div class="col-md-12">
