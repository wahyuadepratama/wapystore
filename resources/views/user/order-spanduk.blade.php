                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="billing-details pr-10">
                                                ...
                                                @endif
                                                <textarea value="{{ old('content') }}" name="content" class="custom-textarea" placeholder="Jelaskan konten spanduk disini. Terdiri dari nama acara, tanggal, waktu, lokasi, jargon, nama organisasi dan konten lainnya "></textarea>
