                    ...
                    <div class="tab-content" style="color: black;">
                        ...
                        <div class="tab-pane active" id="isi-form">
                            <div class="checkout-content box-shadow p-30">
                                <form action="/order/poster/store" method="post" enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                    <div class="row">
                                        <div class="col-md-6" style="margin-bottom: 10%">
                                            <div class="billing-details pr-10">
                                                <h6 class="widget-title border-left mb-20">Ketentuan Order Poster</h6>
                                                <li>
                                                ...
                                                <li>
                                                  3. Pengerjaan paling cepat adalah {{ Config::get('time-work.poster') }} hari
                                                </li>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="billing-details pr-10">
                                                <h6 class="widget-title border-left mb-20">Order Poster</h6>
                                                ...
                                                <small><i> (Opsional) Lampirkan file pendukung yang harus ada di dalam poster, seperti logo, dsb. Max: 5MB (format: zip, rar, png, atau jpg) </i></small>
                                            </div>
                                            <div class="col-md-12">
