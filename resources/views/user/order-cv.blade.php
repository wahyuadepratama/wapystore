                                    ...
                                    <div class="row">
                                        <div class="col-md-6" style="margin-bottom: 10%">
                                            <div class="billing-details pr-10">
                                                ...
                                                <li>
                                                  3. Pengerjaan paling lama adalah {{ Config::get('time-work.cv') }} hari
                                                </li>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="billing-details pr-10">
                                                ...
                                                <small><i> (Opsional) Lampirkan CV selengkap-lengkapnya dalam bentuk word, pdf, atau zip sehingga dapat kami desain dengan optimal </i></small>
                                            </div>
                                            <div class="col-md-12">
