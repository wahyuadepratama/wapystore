              ...
              <div class="row">
                <div class="col-xs-12">
                    <div class="breadcrumbs-inner">
                        <h1 class="breadcrumbs-title">Pamflet</h1>
                    ...
                    <div class="tab-content" style="color: black;">
                        ...
                        <div class="tab-pane active" id="isi-form">
                            <div class="checkout-content box-shadow p-30">
                                <form action="/order/pamflet/store" method="post" enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                    <div class="row">
                                        <div class="col-md-6" style="margin-bottom: 10%">
                                            <div class="billing-details pr-10">
                                                <h6 class="widget-title border-left mb-20">Ketentuan Order Pamflet</h6>
                                                <li>
                                            ...
                                            <div class="billing-details pr-10" style="margin-top: 15%">
                                                ...
                                                <li>
                                                  2. Anda akan mendapatkan kesempatan revisi sebanyak {{ Config::get('revision.pamflet') }}x
                                                </li>
                                            </div>
                                        </div>
                                        <!-- billing details -->
                                        <div class="col-md-6">
                                            ...
                                            <div class="billing-details pr-10">
                                                <h6 class="widget-title border-left mb-20">Order Pamflet</h6>
                                                ...
                                                @endif
                                                <textarea value="{{ old('content') }}" name="content" class="custom-textarea" placeholder="Jelaskan konten pamflet disini. Terdiri dari nama acara, tanggal, waktu, lokasi, jargon, nama organisasi dan konten lainnya " required></textarea>
                                                ...
                                                <small><i> (Opsional) Lampirkan file pendukung yang harus ada di dalam pamflet, seperti logo, dsb. Max: 5MB (format: zip, rar, png, atau jpg) </i></small>
                                            </div>
                                            <div class="col-md-12">
