            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="banner-item banner-2">
                        <div class="banner-img">
                            <a href="#"><img src="{{URL::asset('guest/img/banner/2.jpg')}}" alt=""></a>
                        </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="banner-item banner-3">
                        <div class="banner-img">
                            <a href="#"><img src="{{URL::asset('guest/img/banner/3.jpg')}}" alt=""></a>
                        </div>
                ...
                <div class="col-md-4 hidden-sm col-xs-12">
                    <div class="banner-item banner-4">
                        <div class="banner-img">
                            <a href="#"><img src="{{URL::asset('guest/img/banner/4.jpg')}}" alt=""></a>
                        </div>
                ...
                <div class="row active-featured-product slick-arrow-2">
                        ...
                        <div class="product-item product-item-2">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img src="{{URL::asset('guest/img/product-2/1.jpg')}}" alt=""/>
                                </a>
                            </div>
                    ...
                    <div class="col-xs-12">
                        <div class="product-item product-item-2">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img src="{{URL::asset('guest/img/product-2/2.jpg')}}" alt=""/>
                                </a>
                            </div>
                            <div class="product-info">
                                <h6 class="product-title">
                    ...
                    <div class="col-xs-12">
                        <div class="product-item product-item-2">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img src="{{URL::asset('guest/img/product-2/3.jpg')}}" alt=""/>
                                </a>
                            </div>
                            <div class="product-info">
                                <h6 class="product-title">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-12 col-xs-12">
                    <div class="up-comming-pro gray-bg up-comming-pro-2 clearfix">
                        <div class="up-comming-pro-img f-left">
                            <a href="#">
                                <img src="{{URL::asset('guest/img/up-comming/2.jpg')}}" alt="">
                            </a>
                        </div>
                ...
                <div class="col-md-4 hidden-sm col-xs-12">
                    <div class="banner-item banner-1">
                        ...
                        <div class="banner-img">
                            <a href="#"><img src="{{URL::asset('guest/img/banner/1.jpg')}}" alt=""></a>
                        </div>
                        <div class="banner-info">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                <div class="product-item product-item-2">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="{{URL::asset('guest/img/product-2/5.jpg')}}" alt=""/>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h6 class="product-title">
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                <div class="product-item product-item-2">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="{{URL::asset('guest/img/product-2/6.jpg')}}" alt=""/>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h6 class="product-title">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-xs-12">
                                    <div class="blog-image">
                                        <a href="blog-details.html"><img src="{{URL::asset('guest/img/blog/4.jpg')}}" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <div class="blog-desc">
