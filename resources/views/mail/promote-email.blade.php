    ...
    <div class="wapy-container" style="max-width:728px;margin: 0 auto;font-family: 'Google Sans', sans-serif;background-color: white;">
      ...
      <div class="wapy-content" style="padding: 20px;">
        <p style="font-family: 'Google Sans', sans-serif; font-size: 15px">
          Kami hadir untuk membantu anda dalam menyelesaikan masalah desain di perusahaan atau organisasi anda.
          Dapatkan desain <b>terbaik</b> dan <b>eksklusif</b> hanya di <a href="wapydesign.com"><b>wapydesign.com</b></a>.
          Jika anda ragu, silahkan cek portofolio kami dan dapatkan <b>diskon 10%</b> hanya dengan melakukan registrasi.
          <i><b> "Wapy Design, We create your design"</b></i>
