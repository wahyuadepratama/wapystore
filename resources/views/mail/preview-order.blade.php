  ...
  <body style="background-color: white;margin: 0 auto;font-family: century gothic;">
    ...
    <div class="wapy-container" style="max-width:728px;margin: 0 auto;font-family: century gothic;background-color: white;">
      ...
      <div class="wapy-header" style="padding: 20px 0px;background-color:#f7482d;text-align: center;color: white;">
        <center><h2 style="margin:0px;padding:0px">Preview Pesanan Spanduk #12356</h2></center>
      </div>
      <!-- END HEADER -->
      <!-- CONTENT -->
      <div class="wapy-content" style="padding: 20px;">
        <div class="wapy-preview" style="width:100%">
          <img src="https://lh5.googleusercontent.com/OZEYFoaLn6RgWk_TLzG163NqgHNW0u9c0-i2LBj-njytp4m6gpdobgw_ZUFFbqCDRnEaxXrsiF0_FfyJLSi8=w1366-h626-rw" alt="preview" title="preview" width="100%">
        </div>
        <center>
          <p>Pesanan Anda memiliki kesempatan <b>2 kali revisi</b>. Jika pesanan belum sesuai keinginan silakan tekan tombol <b>Revisi</b> atau <b>Take it!</b> jika sudah sesuai keinginan Anda.</p>
          <br>
        <table>
          <tr>
            <td>
              <center><a href="#" class="wapy-btn" style="padding: 15px;background-color: #f7482d;color: white;text-decoration: none;font-family: century gothic;"><b>Revisi</b></a></center>
            </td>
            <td>
              <center><a href="#" class="wapy-btn" style="padding: 15px;background-color: #f7482d;color: white;text-decoration: none;font-family: century gothic;"><b>Take it!</b></a></center>
            </td>
          </tr>
        </table>
      </center>
