  ...
  <body style="background-color: white;margin: 0 auto;font-family: Century Gothic;">
    ...
    <div class="wapy-container" style="max-width:728px;margin: 0 auto;font-family: Century Gothic;background-color: white;">
      ...
      <div class="wapy-header" style="padding: 20px 0px;background-color:#f7482d;text-align: center;color: white;">
        <center><h2 style="margin:0px;padding:0px">Order Status Spanduk #12356</h2></center>
      </div>
      <!-- END HEADER -->
      <!-- CONTENT -->
      <div class="wapy-content" style="padding: 20px;">
        <p style="font-family: Century Gothic;text-align:justify">Thank you for complete the payment! Your order is on process.
        Preview will be send when your order is finish. Track your order to see the process status. </p>
        <center>

          <br>
              <center><a href="#" class="wapy-btn" style="padding: 15px;background-color: #f7482d;color: white;text-decoration: none;font-family: Century Gothic;"><b>View Order Status</b></a></center>
              <br>
              <p>or</p>
              <br>
              <center><a href="#" class="wapy-btn" style="padding: 15px;background-color: #f7482d;color: white;text-decoration: none;font-family: Century Gothic;"><b>Visit Our Website</b></a></center>
